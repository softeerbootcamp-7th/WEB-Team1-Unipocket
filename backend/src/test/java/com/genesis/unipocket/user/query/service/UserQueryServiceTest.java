...
class UserQueryServiceTest {
    ...
    @Mock
    private com.genesis.unipocket.user.query.persistence.repository.UserQueryRepository userQueryRepository;
    ...
    void getCards_Success() {
        // Given
        UserCardQueryResponse cardResponse = new UserCardQueryResponse(1L, "My Card", "1234", CardCompany.SHINHAN);
