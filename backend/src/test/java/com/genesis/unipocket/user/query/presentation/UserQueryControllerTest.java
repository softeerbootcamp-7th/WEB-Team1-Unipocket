...
class UserQueryControllerTest {
    ...
    void getMyInfo_Success() throws Exception {
        ...
        UserQueryResponse response = new UserQueryResponse(userId, "test@example.com", "Tester", "img.jpg",
    ...
    void getCards_Success() throws Exception {
        UUID userId = UUID.randomUUID();
        String accessToken = "valid_token";
        UserCardQueryResponse card1 = new UserCardQueryResponse(1L, "Card 1", "1234", CardCompany.HYUNDAI);
    ...
    void getCardCompanies_Success() throws Exception {
        ...
        mockMvc
                .perform(get("/api/users/cards/companies"))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$[0]").value("HYUNDAI")) // Verify Enum serialization (should be String now)
