...
public class ObservabilityAspect {
    ...
    @Pointcut("execution(* com.genesis.unipocket..*Worker.*(..)) || execution(* com.genesis.unipocket..*Scheduler.*(..))")
    ...
    @Around("servicePointcut() || controllerPointcut() || repositoryPointcut() || workerPointcut() || externalApiPointcut() || trackTimePointcut()")
    ...
    private void recordMetricsAndLog(
            ProceedingJoinPoint joinPoint, long durationNaos, boolean success, Throwable exception) {
