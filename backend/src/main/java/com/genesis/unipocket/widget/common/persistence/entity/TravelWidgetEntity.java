package com.genesis.unipocket.widget.common.persistence.entity;
...
@Table(
		name = "travel_widgets",
		uniqueConstraints = @UniqueConstraint(columnNames = {"travel_id", "display_order"}))
@AllArgsConstructor
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class TravelWidgetEntity extends BaseEntity {
