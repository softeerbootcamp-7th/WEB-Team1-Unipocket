...
@Builder
@Table(
		name = "country_daily_category_aggregate",
		uniqueConstraints = {
			@UniqueConstraint(
					name = "uk_country_daily_category_aggregate",
					columnNames = {"country_code", "target_local_date", "category", "quality_type"})
		})
@AllArgsConstructor(access = AccessLevel.PRIVATE)
@NoArgsConstructor(access = AccessLevel.PROTECTED)
public class CountryDailyCategoryAggregateEntity extends BaseEntity {
	...
	public static CountryDailyCategoryAggregateEntity of(
			...
			long expenseCount) {
		return CountryDailyCategoryAggregateEntity.builder()
				.countryCode(countryCode)
